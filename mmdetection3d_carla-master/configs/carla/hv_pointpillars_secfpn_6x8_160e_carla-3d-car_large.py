# model settings
_base_ = [
    '../_base_/models/hv_pointpillars_secfpn_carla_large.py',
    '../_base_/datasets/carla-3d-car_large.py',
    '../_base_/schedules/cyclic_40e.py', '../_base_/default_runtime.py'
]

point_cloud_range = [-154, -120, -0.1, 54, 120, 3.9]
model = dict(
    bbox_head=dict(
        type="Anchor3DHead",
        num_classes=1,
        anchor_generator=dict(
            ...
            ranges=[[-153.68, -119.04, 0.72, 53.68, 119.04, 0.72]],
            sizes=[[3.9, 1.6, 1.56]],
            rotations=[0, 1.57],
            reshape_out=True,
        )
